  ...
  return (
    <section ref={featuresRef}>
      <motion.div
        ...
        initial="hidden"
        animate={control}
        className="lg:mt-[300px] sm:mt-[200px] xs:mt-[100px] sm:grid xs:flex xs:flex-col lg:grid-rows-2 lg:grid-cols-3 sm:grid-rows-3 sm:grid-cols-2 sm:grid-flow-row lg:gap-[30px] xs:gap-[20px] lg:mr-20 sm:mr-16 xs:mr-10 lg:ml-20 sm:ml-16 xs:ml-10 xs:justify-center xs:items-center"
      >
