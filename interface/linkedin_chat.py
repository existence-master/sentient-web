...
def app():
    ...
    with st.sidebar:
        ...
        menu = option_menu(None, ["Chat", "LinkedIn Advice", "Settings", "Logout"], icons=["chat-fill", "linkedin", "gear", "box-arrow-in-left"], menu_icon = "cast", default_index = 1, on_change = on_page_change)
        menu      
