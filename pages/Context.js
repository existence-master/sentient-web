        ...
        <section>
            ...
            <motion.div ref={fifthContextRef} style={{opacity: fifthContextOpacity}} className="flex flex-col">
                <div className="relative">
                    <Image src="/context-blob-3.svg"  width = {0} height={0} sizes="100vh" className="w-screen sm:left-0 sm:right-0" alt="Context Blob 3" />
                    <Image src="/sentient-chat.png" width={0} height={0} sizes="100vh" className="w-screen absolute sm:left-0 top-0" alt="Sentient Chat" />
                </div>
