...
const Steps = () => {
  ...
  return (
    <section>
      <div className="flex flex-col lg:gap-[70px] sm:gap-[50px] xs:gap-[30px] lg:mr-20 sm:mr-16 xs:mr-10 lg:ml-20 sm:ml-16 xs:ml-10 h-screen justify-center">
        <motion.h3 ref={firstTextRef} style={{ x: firstTextX }} className="font-Quicksand font-bold lg:text-[50px] sm:text-[25px] xs:text-[15px] text-left text-white">
          quick signup
        </motion.h3>
        ...
        <motion.h3 ref={thirdTextRef} style={{ x: thirdTextX }} className="font-Quicksand font-bold lg:text-[50px] sm:text-[25px] xs:text-[15px] text-right text-white">
