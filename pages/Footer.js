...
const Footer = () => {
  ...
  return (
    <section>
      <div id="earlyAdopter" className="z-10 relative flex flex-col h-screen lg:gap-[50px] xs:gap-[30px] justify-center items-center lg:mr-20 sm:mr-16 xs:mr-10 lg:ml-20 sm:ml-16 xs:ml-10">
        ...
        {submit==true ?
            error == null ? (
              ...
              <motion.button whileHover={{ scale: 1.2, transition: { duration: 0.5 } }} type="submit" onClick={handleSubmit} className="flex-none bg-gradient-to-b from-[#9E00D1] to-[#4E31FF] lg:px-8 sm:px-6 xs:px-4 lg:py-4 sm:py-3 xs:py-2 rounded-[12px] font-Montserrat sm:font-semibold xs:font-medium lg:text-lg sm:text-md xs:text-sm text-white">
                  submit
                </motion.button>
              </div>
            )
